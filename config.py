...
# ── Polymarket CLOB API ──
# Running in EU region (Railway eu-west) — direct access to clob.polymarket.com.
...
FEE_WALLET_ADDRESS = os.environ.get("FEE_WALLET_ADDRESS", "0xE692556996F6c7934e9200a284270A57Fd2ED7d1")
